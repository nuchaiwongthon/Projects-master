...
public class SelectTypeVegdisease3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                SelectTypeVegdisease3.this.finish();
            }
        });
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent newActivity = new Intent(SelectTypeVegdisease3.this, SelectSyndrome4.class);
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent newActivity = new Intent(SelectTypeVegdisease3.this, SelectSyndrome13.class);
                newActivity.putExtra("strVegdisID", strVegdisID);
                startActivity(newActivity);
